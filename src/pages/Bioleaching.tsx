...
const steps = [
  {
    ...
    details: [
      "Mine tailings and waste dumps are common bioleaching feedstock",
      "Copper, gold, and uranium ores with <1% metal content are viable",
      "E-waste can also be processed via bioleaching methods",
    ],
  },
  {
    icon: "⚙️",
    ...
    details: [
      "Coarse crushing to ~10cm is often sufficient",
      "Heap leaching uses run-of-mine ore with minimal processing",
      "Agitation leaching uses finer particles for faster results",
    ],
  },
  {
    icon: "🦠",
    title: "Microbial Action",
    ...
    details: [
      "Bacteria produce sulfuric acid and ferric iron as oxidizing agents",
      "Process operates at ambient temperature (20–40°C)",
      "Heap, dump, or stirred-tank bioreactors are used",
    ],
  },
  {
    icon: "🧪",
    ...
    details: [
      "Solvent extraction separates copper from the pregnant solution",
      "Cementation precipitates gold using zinc dust",
      "Further electrorefining achieves final purity",
    ],
  },
  {
    icon: "🥇",
    ...
    details: [
      "~20% of world copper production uses bioleaching",
      "Gold recovery from refractory ores is a major application",
      "Uranium extraction for nuclear fuel is commercially practiced",
    ],
  },
];
...
const Bioleaching = () => (
  <TechStepPage
    techId="bio"
    techName="Bioleaching"
    techEmoji="🦠"
    techColor="bio"
    steps={steps}
    videoUrl="https://www.youtube.com/embed/329RMsMqHOc"
    videoTitle="Bioleaching Explained"
